...
?>
 ...
 <div class="row no-gutter fullwidth"><!-- row -->
                ...
                <div class="col-lg-12 col-md-4 "><!-- misc wrapper -->
                        ...
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                            ...
                            <li class="widget-container widget_text"><!-- widget -->
                                <div class="col-lg-4">
                                    ...
                                    <a href="index.html#" class="custom-button cb-green" title="How to apply?">
                                ...
                                <div class="col-lg-4">
                                    <a href="index.html#" class="custom-button cb-gray" title="Campus tour">
                                ...
                                <div class="col-lg-4">
                                    <a href="index.html#" class="custom-button cb-yellow" title="Prospectus">
